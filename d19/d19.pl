...
normalize_all(Scanners, Positions, Beacons) :-
    alignements(Scanners, Transforms),
    maplist(write_debug, Transforms),
    write_debug("normalizing"),
